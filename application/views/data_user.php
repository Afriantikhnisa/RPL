	...
	<?php include(__DIR__ . "/load_js.php"); ?>
		...
		$(document).ready(function(){
			var tabel = $('#tabel-data').dataTable({
				...
				"sAjaxSource": 	'<?php echo base_url(); ?>data_user/data',
				"aoColumns":	[
									{ "mData"	: "no"},
									{ "mData"	: "username"},
									{ "mData"	: "password"},
				...
				function(isConfirm){
					if (isConfirm) {
						$.ajax({
							type: 		'ajax',
							method: 	'post',
							url: 		'<?=base_url()?>'+'data_user/hapus/' + kode,
							async: 		true,
							dataType: 	'json',
